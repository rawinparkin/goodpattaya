...
@section('title')
{{ $purpose_word }}{{ $props[0]['category']['name'] }} {{ $props[0]['location']['name'] }} | Goodpattaya
@endsection
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="select-wrap">
                            ...
                            <select name="category_id" id="list-types" class="form-control d-block rounded-0">
                                ...
                                <option value="{{ $item->id }}" {{ $props[0]->category_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                </option>
                                @endforeach
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="select-wrap">
                            ...
                            <select name="location_id" id="select-city" class="form-control d-block rounded-0">
                                ...
                                <option value="{{ $item->id }}" {{ $props[0]->location_id == $item->id ? 'selected' : '' }}>{{ $item->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
    ...
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                ...
                purpose_id: {
                    required: 'Please Choose Purpose',
                },
                location_id: {
